...
+(UIColor *)colorOfSxiSix{
    UIColor *color = [UIColor colorWithHexString:@"#666666"];//  ecececgu
    return color;
}

+(UIColor *)colorOfButton{
    UIColor *color = [UIColor colorWithHexString:@"#fdc22d"];//  ecececgu
    return color;
}
//文字以及标题栏黄
+(UIColor *)colorOfYellow{
    UIColor *color = [UIColor colorWithHexString:@"#fed530"];//  ecececgu
    return color;
}
